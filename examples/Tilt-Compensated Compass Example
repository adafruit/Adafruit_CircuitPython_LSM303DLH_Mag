...
# for Phi (Roll)
# Phi = atan2(Gy, Gz) # for stability, 'Gz' can be substituted with Gz+Gx*alpha (with alpha=0.01-0.05)
...
i2c = board.I2C()  # uses board.SCL and board.SDA. Equivalent to the older method: i2c = busio.I2C(board.SCL, board.SDA)
